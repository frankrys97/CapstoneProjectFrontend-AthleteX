  ...
  return (
    <div className="homepage">
      ...
      {!loading && user.userType === "COACH" && teams && teams.length === 0 && (
        <Container
          fluid
          className="main-content d-flex align-items-center justify-content-center text-secondary mt-2 "
        >
          <Row className="w-100 gap-3">
            <Col xs={12}>
              <div className="d-flex flex-column align-items-center mb-4 gap-3">
                <h3 className="text-center">
                  Non gestisci nessuna squadra ... ancora!
                </h3>
            ...
            <Col md={6} className="mx-auto">
              <Card
                className="text-center p-3 mx-auto border-0 text-secondary rounded-0 card-create"
                onClick={() => handleNavigate("/team/create")}
              >
                <Card.Body className="d-flex flex-column align-items-center gap-3">
                  ...
                  <Button
                    variant="secondary"
                    size="sm"
                    className="px-3 py-2 btn-create border-0"
                    onClick={() => handleNavigate("/team/create")}
                  >
              ...
              <p className="text-center mt-5">
                <IoIosInformationCircleOutline /> Per vivere al meglio
                l&apos;esperienza con AthleteX ti consigliamo di creare una
                squadra al più presto!
              </p>
            </Col>
          </Row>
        </Container>
          ...
          <Row className="w-100 h-100 g-3 d-flex justify-content-start gy-5">
            <Col xs={12}>
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  className="px-3 py-2 border-0 btn-create d-none d-md-block"
                  onClick={() => handleNavigate("/team/create")}
                >
            ...
            {teams.map((team) => {
              ...
              const isDefaultAvatar =
                !team?.avatar ||
                team?.avatar?.includes("https://ui-avatars.com/api/");
                  ...
                  <Card className="mb-3 team-card shadow-sm border-0 d-flex flex-column equal-height w-100 h-100 ">
                    <Card.Body className="d-flex flex-column justify-content-start">
                      <div className="team-avatar">
                        <img
                          src={isDefaultAvatar ? iconaScudetto : team.avatar}
                          alt={`${team.name} logo`}
                          style={{
                            width: "100%",
                            height: "100%",
                          ...
                          className={` ${
                            !isDefaultAvatar ? "default-avatar" : ""
                          }`}
                        />
                      </div>
                      <div className=" d-flex justify-content-end align-items-center gap-2 align-self-end">
                        ...
                        <Dropdown as={ButtonGroup}>
                          <Dropdown.Toggle
                            variant="transparent"
                            className="py-1 px-2 border-1 dropstyle"
                          >
                      ...
                      <div
                        onClick={() => handleTeamPage(team.id, team.name)}
                        className="text-decoration-none w-100 text-secondary"
                        style={{ cursor: "pointer" }}
                      >
                        <Card.Title className="mt-3 text-nowrap overflow-auto">
                          {team.name}
                        </Card.Title>
            ...
            <Button
              variant="secondary"
              size="sm"
              className="px-3 py-2 border-0 btn-create d-block d-md-none mb-2"
              onClick={() => handleNavigate("/team/create")}
            >
              Crea una nuova squadra
            </Button>
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              {selectedTeam
                ...
                : "Seleziona una squadra per eliminarla."}
            </Modal.Body>
            <Modal.Footer>
      ...
      {!loading && user.userType === "PLAYER" && !user.team && (
        <Container
          fluid
          className="main-content d-flex align-items-center justify-content-center text-secondary "
        >
          <Row className="w-100 gap-3">
            <Col xs={12}>
              <div className="d-flex flex-column align-items-center mb-4">
                <h3 className="text-center">
                  Non fai parte di nessuna squadra ... ancora!
                </h3>
            ...
            <Col md={6} className="mx-auto">
              <Card className="text-center p-3 mx-auto border-0 text-secondary rounded-0 card-create">
                <Card.Body className="d-flex flex-column align-items-center gap-3">
                  ...
                  <Button
                    ...
                    onClick={() => handleNavigate("/team/join")}
                  >
              ...
              <p className="text-center mt-3">
                <IoIosInformationCircleOutline /> Per vivere al meglio
                l&apos;esperienza con AthleteX ti consigliamo di unirti ad una
                squadra al più presto!
              </p>
            </Col>
          </Row>
      ...
      {!loading && user.userType === "PLAYER" && user.team && (
        <Container className="mt-3">
                ...
                <Col md={6} key={team.id} className="mx-auto">
                  <Card className="text-center p-3 mx-auto border-0 text-secondary rounded-0 card-create position-relative">
                    <Card.Body className="d-flex flex-column align-items-center gap-3">
                      ...
                      <Card.Title className="d-flex align-items-center gap-1 mt-2">
                        {" "}
                        <PiSoccerBallThin />
                        <span>{team.name}</span>{" "}
                      </Card.Title>
                      <Card.Text>Non perderti nessun aggionamento!</Card.Text>
                      <Button
                        variant="secondary"
                        size="sm"
                        className="px-3 py-2 btn-create border-0 mt-2"
                  ...
                  <p className="text-center mt-5">
                    <IoIosInformationCircleOutline /> Grazie ad AthleteX, sarai
                    in grado di far parte di una squadra in modo smart e non
                    perderti più alcuna informazione!
                  </p>
                </Col>
              );
            })}
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              {selectedTeam
                ? `Sei sicuro di voler lasciare la squadra: ${selectedTeam.name}?`
                : "Seleziona una squadra per lascire."}
            </Modal.Body>
            <Modal.Footer>
              <Button variant="secondary" size="sm" onClick={handleClose}>
                Chiudi
