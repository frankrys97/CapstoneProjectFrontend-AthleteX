...
const ThankYouPage = () => {
    ...
    return (
        <div className="thankyou-page">
            {/* Navbar */}
            <Navbar expand="lg" variant='light' className="bg-secondary w-100">
                <Container>
            ...
            <Container fluid className="h-100 d-flex align-items-center justify-content-center thankyou-container">
                <Row className="justify-content-center" style={{zIndex: 99999}}>
                    <Col md={8}>
                    <div className='d-flex flex-column align-items-center justify-content-center'>

                        <h1 className="text-center">Grazie per la tua risposta!</h1>
                        <p className="text-center">Capiamo che entrare a far parte di una squadra non sia una decisione facile.</p>
